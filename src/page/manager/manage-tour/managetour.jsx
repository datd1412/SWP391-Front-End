...
function ManageTour() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "image",
      render: (image) =>
        image ? <Image width={50} src={image} /> : <div>No Image</div>,
    },
    {
      title: "Tour Name",
      dataIndex: "tourName",
      ...
      >
        <Form form={form} labelCol={{ span: 24 }} onFinish={handleSubmit}>
          ...
          <Form.Item
            ...
            label="Price (Adult)"
            rules={[
              { required: true, message: "Please input the price for adults!" },
            ]}
          >
            <Input type="number" />
          </Form.Item>
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input the price for children!",
              },
            ]}
          >
            <Input type="number" />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input the number of recipients!",
              },
            ]}
          >
            <Input type="number" />
